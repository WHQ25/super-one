...
export function readAppSettings(): AppSettings {
  try {
    ...
    return {
      ...
      cdpNetworkEnabled: typeof data.cdpNetworkEnabled === 'boolean' ? data.cdpNetworkEnabled : defaults.cdpNetworkEnabled,
    ...
    return {
      ...
      cdpNetworkEnabled: defaults.cdpNetworkEnabled,
...
export function saveAppSettings(patch: AppSettingsPatch): AppSettings {
  ...
  const merged: AppSettings = {
    ...
    cdpNetworkEnabled: patch.cdpNetworkEnabled === undefined ? current.cdpNetworkEnabled : patch.cdpNetworkEnabled,
