...
export function readAppSettings(): AppSettings {
  try {
    ...
    return {
      ...
      dshToolCordis: typeof data.dshToolCordis === 'boolean' ? data.dshToolCordis : defaults.dshToolCordis,
    ...
    return {
      ...
      dshToolCordis: defaults.dshToolCordis,
...
export function saveAppSettings(patch: AppSettingsPatch): AppSettings {
  ...
  const merged: AppSettings = {
    ...
    dshToolCordis: patch.dshToolCordis === undefined ? current.dshToolCordis : patch.dshToolCordis,
