...
const CODEX_EFFORT_VALUES = ['minimal', 'low', 'medium', 'high', 'xhigh', 'max', 'ultra'] as const
...
const ALL_SETTINGS_DOMAINS: SettingsDomainDef[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'boolean',
        note: 'Experimental browser_run / computer_run / device_run tools driven by TypeSafe Jev. Needs a Jev API key entered in Settings → General → Experimental; browser runs also need CDP.',
