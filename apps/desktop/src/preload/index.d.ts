...
interface AppAPI {
  ...
  // Codex Goal
  codexGetGoal(projectPath: string, threadId: string): Promise<CodexGoal | null>
  codexSetGoal(projectPath: string, threadId: string, objective: string): Promise<CodexGoal | null>
  codexClearGoal(projectPath: string, threadId: string): Promise<boolean>
