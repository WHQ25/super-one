...
export const FastRunStates: Story = {
  render: () => (
    <StoryShell width={560}>
      <Note>Collapsed, a run is one row: verb, app, what the caller asked for and how it ended; the step count shows only while it runs, and steps and time sit in the footer once expanded.</Note>
