...
export const DEVICE_EXPANDED_BOX: React.CSSProperties = {
 ...
 *
 * Split out from `DevicePictureInPicture` for one reason — paint order. The
 * device itself lives in `DeviceHostLayer`, between this and the preview's
 ...
 */
export function DeviceOverlaySurface() {
  const { expanded } = useDevicePreview()
