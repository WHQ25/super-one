...
import type { IosSimulatorPreviewMode } from '@superone/shared/ios-simulator'

export function preferredDevicePreviewMode(): IosSimulatorPreviewMode {
...
export class DeviceFrameRenderer {
  ...
  private configure(frame: DeviceFrame): void {
