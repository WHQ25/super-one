...
const DETAIL_SCREENS = new Set(['chat', 'terminal', 'worktree', 'branch', 'project-picker', 'settings', 'files'])
 ...
 */
const FULL_BLEED_SCREENS = new Set(['chat', 'terminal', 'worktree', 'branch', 'project-picker'])
