...
const DETAIL_SCREENS = new Set(['chat', 'terminal', 'worktree', 'branch', 'add-dir', 'file-preview', 'project-picker', 'add-project', 'settings', 'files'])
 ...
 */
const FULL_BLEED_SCREENS = new Set(['chat', 'terminal', 'worktree', 'branch', 'add-dir', 'file-preview', 'project-picker', 'add-project', 'files', 'session-search'])
