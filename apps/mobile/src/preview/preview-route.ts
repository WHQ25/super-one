...
export const shellPreviewPages = ['New session', 'Chat', 'Icons', 'Chip editor', 'Devices', 'Pairing', 'Projects', 'Sessions', 'Settings', 'Files', 'Empty folder', 'Folder error', 'Terminal'] as const
