...
export const shellPreviewPages = ['New session', 'Chat', 'Worktree', 'Branch', 'Icons', 'Git indicators', 'Chip editor', 'Devices', 'Pairing', 'Projects', 'Sessions', 'Settings', 'Files', 'Empty folder', 'Folder error', 'Terminal', 'LAN browser', 'Tool catalog'] as const
