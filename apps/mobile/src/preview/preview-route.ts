...
export const shellPreviewPages = ['New session', 'Chat', 'Project', 'Add project', 'Worktree', 'Branch', 'Icons', 'Git indicators', 'Session status', 'Composer suggestions', 'Chip editor', 'Devices', 'Pairing', 'Workspace', 'Session search', 'Settings', 'Files', 'Computer files', 'File search', 'Go to folder', 'Empty folder', 'Folder error', 'Terminal', 'LAN browser', 'Tool catalog'] as const
