...
export function usePromptStyles() {
  ...
  return useMemo(() => {
    ...
    return StyleSheet.create({
      ...
      title: { color: c.foreground, fontSize: 14, fontWeight: '600', lineHeight: 20 },
      body: { color: c.foreground, fontSize: 13, lineHeight: 20 },
      meta: { color: c.mutedForeground, fontSize: 12, lineHeight: 18 },
      label: { color: c.mutedForeground, fontSize: 11, fontWeight: '600', letterSpacing: 0.5, textTransform: 'uppercase' },
      ...
      choice: { flexDirection: 'row', alignItems: 'flex-start', gap: s.sm, paddingHorizontal: 10, paddingVertical: 10, minHeight: 42, borderRadius: r.md, borderWidth: 1, borderColor: c.border },
      selectedChoice: { borderColor: c.primary, backgroundColor: tint(c.primary) },
      choiceIcon: { marginTop: 1 },
      pill: { borderWidth: 1, borderColor: c.border, borderRadius: r.sm, paddingHorizontal: 10, paddingVertical: 7, minHeight: 36, justifyContent: 'center' },
      selectedPill: { backgroundColor: c.primary, borderColor: c.primary },
      pillText: { color: c.foreground, fontSize: 13, lineHeight: 18 },
      selectedPillText: { color: c.primaryForeground, fontWeight: '600' },
      ...
      action: { flex: 1, minWidth: 0, minHeight: 42, borderRadius: r.md, paddingHorizontal: 10, paddingVertical: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 6 },
      actionText: { fontSize: 13, lineHeight: 18, fontWeight: '600', flexShrink: 1, textAlign: 'center' },
