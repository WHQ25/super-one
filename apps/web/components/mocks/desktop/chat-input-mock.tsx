...
import { ArrowUp, Box, ChevronDown, Circle, GitBranch, Monitor, Paperclip, Shield } from "lucide-react"
...
export function ChatInputMock({
  ...
  return (
    <div className={cn("mx-auto w-full min-w-0 max-w-3xl", className)}>
      <div className="relative mx-3 rounded-xl border border-border px-4 py-3">
...
function ChatStatusBarMock({ harness, branch, branchDirty, permissionLabel, sandboxLabel }: ChatStatusBarMockProps) {
  return (
    <div className="flex items-center gap-2 whitespace-nowrap px-3 pb-1 pt-0.5 text-[11px] text-muted-foreground">
      <span className="flex items-center gap-1 rounded-lg px-2 py-1">
