...
**2026-09-04 (WP-29 recovery OTA):** published commit `19ad04e3` to the `production` channel for Android and iOS runtime `1.0.0` as update group `25c7b31b-47a2-4c0a-abde-57220f3b1411`; a follow-up `eas update:list` confirmed it is the newest production group. EAS still reports no iOS submission record. App Store Connect login/app creation, TestFlight processing, physical iPhone/Android smoke, Flutter archival, and the final merge remain pending.
