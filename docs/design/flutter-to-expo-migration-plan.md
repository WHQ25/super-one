...
Android 16 device; camera permission plus QR scanner open/cancel passed. iOS signing,
physical-device distribution and smoke, the first matching update, and Flutter
