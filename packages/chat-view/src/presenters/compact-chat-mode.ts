export interface CompactChatModePorts {
  isWidgetShowTool(toolName: string): boolean
}
 ...
 */
export function isPinnedToolName(toolName: string, ports: CompactChatModePorts): boolean {
  return ports.isWidgetShowTool(toolName)
