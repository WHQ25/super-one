...
export const AgentIpcChannels = {
  ...
  DEEPSEEK_TRAJECTORY_PAGE: 'app:deepseek-trajectory-page',
  DEEPSEEK_TRAJECTORY_PAYLOAD: 'app:deepseek-trajectory-payload',
  DEEPSEEK_TRAJECTORY_WATCH: 'app:deepseek-trajectory-watch',
  DEEPSEEK_TRAJECTORY_CHANGED: 'app:deepseek-trajectory-changed',
  SAVE_TEXT_AS: 'app:save-text-as',
  ...
  STEER_QUEUED_MESSAGE: 'agent:steer-queued-message',
  ...
  GIT_WORKTREE_EXISTS: 'app:git-worktree-exists',
  ...
  MINIAPP_SHOW_ITEM_IN_FOLDER: 'miniapp:show-item-in-folder',
  MINIAPP_START_DRAG: 'miniapp:start-drag',
  MINIAPP_GET_PRELOAD_PATH: 'miniapp:get-preload-path',
  MINIAPP_HOST_POST_MESSAGE: 'miniapp:host-post-message',
  ...
  /** main → renderer: a MiniApp Host asks the renderer to perform a host action. */
  MINIAPP_HOST_ACTION: 'miniapp:host-action',
  /** renderer → main: result of one MINIAPP_HOST_ACTION. */
  MINIAPP_HOST_ACTION_RESULT: 'miniapp:host-action-result',
  /** renderer → main: the agent consumed a mini-app's context card. */
  MINIAPP_CONTEXT_CONSUMED: 'miniapp:context-consumed',
