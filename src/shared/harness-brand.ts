...
function buildHarnessDefaults(harness: HarnessId): Record<DesignToken, LCH> {
  ...
  const a = 1
  return {
    '--background': { l: 0.96, c: 0.015, h, a },
    '--card': { l: 0.99, c: 0.005, h, a },
    '--popover': { l: 0.99, c: 0.005, h, a },
    '--secondary': { l: 0.93, c: 0.012, h, a },
    '--muted': { l: 0.93, c: 0.01, h, a },
    '--accent': { l: 0.91, c: 0.025, h, a },
    '--border': { l: 0.88, c: 0.012, h, a },
    '--input': { l: 0.88, c: 0.012, h, a },
    '--sidebar': { l: 0.98, c: 0.012, h, a },
    '--sidebar-accent': { l: 0.94, c: 0.022, h, a },
    '--sidebar-border': { l: 0.92, c: 0.015, h, a },
